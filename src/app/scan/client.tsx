...
export default function ScanClientPage() {
    ...
    const pchForm = useForm<PchFormValues>({
        ...
        defaultValues: { barcode: '', designation: '', lotNumber: '', quantity: 1, expiryDate: '', category: '', conditionnement: 'Cacheté' },
    });
    ...
    const handlePchSubmit = async (values: PchFormValues) => {
        ...
        try {
            ...
            pchForm.reset({ barcode: '', designation: '', lotNumber: '', quantity: 1, expiryDate: '', category: '', conditionnement: 'Cacheté' });
            setMode('selection');
        } catch (error) {
